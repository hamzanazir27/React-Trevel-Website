function About() {
  return (
    <section className="px-6 py-16 max-w-screen-xl mx-auto bg-gray-50">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            traveler. Whether you're a solo explorer, a couple on honeymoon, or
            a family group, we've got you covered.
          </p>
        </div>
